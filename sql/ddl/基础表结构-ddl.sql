...
(
    ...
    `sales_price` decimal(10, 2) DEFAULT NULL COMMENT '销售价（默认售价）',
    `inventory`   decimal(10, 2) DEFAULT NULL COMMENT '库存量',
...
(
    ...
    `order_amount` decimal(10, 2) DEFAULT NULL COMMENT '数量',
